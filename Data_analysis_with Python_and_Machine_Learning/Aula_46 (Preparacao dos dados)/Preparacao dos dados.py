...
caminho_arquivo_Excel_prom ='D:/23) Programação/Cursos/Python/5) Analise de dados com Python e Machine Leearning - 5 horas/Aula_46 (Preparacao dos dados)/caso_estudo_venda_promocao.csv'
dfclientes = pd.read_excel('caso_estudo.xlsx', sheet_name='clientes')
dflojas = pd.read_excel('caso_estudo.xlsx', sheet_name='lojas')
dfprodutos = pd.read_excel('caso_estudo.xlsx', sheet_name='produtos')
dfvendas = pd.read_excel('caso_estudo.xlsx', sheet_name='vendas')
dfpagamentos = pd.read_excel('caso_estudo.xlsx', sheet_name='pagamentos')
dfPromo = pd.read_csv('D:/23) Programação/Cursos/Python/5) Analise de dados com Python e Machine Leearning - 5 horas/Aula_46 (Preparacao dos dados)/caso_estudo_venda_promocao.csv', sep=";")
