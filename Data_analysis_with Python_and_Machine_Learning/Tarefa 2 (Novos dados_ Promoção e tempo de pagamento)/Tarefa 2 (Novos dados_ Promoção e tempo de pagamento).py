...
caminho_arquivo_Excel_prom ='D:/23) Programação/Cursos/Python/5) Analise de dados com Python e Machine Leearning - 5 horas/Tarefa 2 (Novos dados_ Promoção e tempo de pagamento)/caso_estudo_venda_promocao.csv'
...
#lendo arquivo CSV
dfPromo = pd.read_csv('D:/23) Programação/Cursos/Python/5) Analise de dados com Python e Machine Leearning - 5 horas/Tarefa 2 (Novos dados_ Promoção e tempo de pagamento)/caso_estudo_venda_promocao.csv', sep=";")
#definir index
