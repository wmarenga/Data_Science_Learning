...
caminho_arquivo_Excel_prom ='D:/23) Programação/Cursos/Python/5) Analise de dados com Python e Machine Leearning - 5 horas/Aula_50 (XGBoost)/caso_estudo_venda_promocao.csv'
...
" Utilizado para um modelo binario "
model = XGBClassifier()
